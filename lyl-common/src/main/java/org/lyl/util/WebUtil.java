...
public final class WebUtil {
    ...
    private static Logger logger = LogManager.getLogger("WebUtil");
	...
	public static final Long getCurrentUser() {
		...
		if (null != currentUser) {
			try {
                ...
                if (null != session) {
                	System.out.println(session.getAttribute(Constants.CURRENT_USER));
//                	return (Long) session.getAttribute(Constants.CURRENT_USER);
                	return Long.valueOf(session.getAttribute(Constants.CURRENT_USER).toString()) ;
                }
