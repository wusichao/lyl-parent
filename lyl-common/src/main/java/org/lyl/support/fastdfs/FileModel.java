package org.lyl.support.fastdfs;
...
public class FileModel implements Serializable {
	...
	public String toString() {
		return "FileModel [namespace=" + namespace + ", objectId=" + objectId + ", key=" + key + ", content="
				+ Arrays.toString(content) + ", ext=" + ext + ", mime=" + mime + ", size=" + size + ", filename="
				+ filename + ", remotePath=" + remotePath + "]";
	}
